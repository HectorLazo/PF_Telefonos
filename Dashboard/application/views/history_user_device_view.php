...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="container">
        ...
        <h3>Historial <?php print_r($POS_NOMBRE_VENDEDOR) ?> user</h3>

<div class="jumbotron">

    <label>Codigo Vendedor    :<?php print($POS_CODIGO_VENDEDOR) ?>   </label>
    <br>
    <label>Codigo Oficina     : <?php print($POS_CODIGO_OFICINA) ?>   </label>
    <br>
    <label>Numero Telefonico  : <?php print($POS_NUMERO_TELEFONO) ?> </label>

</div>
        <br />
        <button class="btn btn-success" onclick="add_adm_device(<?php print($POS_CODIGO_VENDEDOR) ?>)"><i class="glyphicon glyphicon-plus"></i> Add New Device</button>
...
$(document).ready(function() {
    ...
    id=<?php print_r($POS_CODIGO_VENDEDOR)?>;
   // alert(id);
    //datatables
...
function add_adm_device(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('person/ajax_find_by_id/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="p_nom_vendedor"]').val(data.POS_NOMBRE_VENDEDOR);
            $('[name="p_nom_vendedor"]').prop("readonly", true);
            $('[name="p_cod_vendedor"]').val(data.POS_CODIGO_VENDEDOR);
            $('[name="p_cod_vendedor"]').prop("readonly", true);
            $('[name="p_oficina"]').val(data.POS_CODIGO_OFICINA);
           // $('[name="p_oficina"]').prop("disabled", true);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Add new device Vendedor'); // Set title to Bootstrap modal title
...
function add_support(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Agregar Soporte'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('person/ajax_add_adm_device')?>";
    } else {
...
function admin_device_history(id){
    alert("asdadsa");
    if(confirm('Are you sure data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('person/admin_device_history')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function desactivar(id)
{
    if(confirm('Are you sure deactivate?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('person/ajax_delete_adm_device')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="p_cod_vendedor" placeholder="Codigo Vendedor" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="p_nom_vendedor" placeholder="Nombre Vendedor" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="p_numero" placeholder="Numero Telefono" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="p_oficina" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="p_modelo" placeholder="Numero Telefono" class="form-control" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
