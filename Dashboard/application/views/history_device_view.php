...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="container">
        ...
        <h3>Historial <?php print_r($POS_IMEI) ?> </h3>

<div class="jumbotron">

    <label>IMEI    :<?php print($POS_IMEI) ?>   </label>
    <br>
    <label>Modelo Telefono     : <?php print($POS_DEVICE) ?>   </label>
    <br>

</div>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add New Device</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="address" placeholder="Descripcion" rows="5" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
